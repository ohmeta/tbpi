...
class tbpiconfig:
    ...
    def __init__(self, work_dir):
        ...
        self.tbpi_dir = os.path.dirname(os.path.abspath(__file__))

        self.config_file = os.path.join(self.tbpi_dir, "config", "config.yaml")
        self.envs_dir = os.path.join(self.tbpi_dir, "envs")
        self.profiles_dir = os.path.join(self.tbpi_dir, "profiles")
...
Thanks for using tbpi.

A TCR/BCR project has been created at %s


if you want to create fresh conda environments:

        tbpi bcr_wf --conda-create-envs-only
        tbpi tcr_wf --conda-create-envs-only
...
""" % (
    ...
    def create_dirs(self):
        ...
        for sub_dir in tbpiconfig.sub_dirs:
